...
function Models() {
  ...
  const services = [
    ...
    { title: "Specialization work action team", content: "Develop cutting-edge web and mobile applications to stay competitive." },
  ...
  return (
    <section className="bg-black px-4 py-18">
      <div className="flex flex-col lg:flex-row items-start justify-center max-w-[80%] mx-auto space-y-10 lg:space-y-0 lg:space-x-10">
        {/* Left Content */}
