...
const coreValues = [
  ...
  { icon: <FaTrophy className="text-black text-4xl" />, title: "Synergy", color: "bg-[#feead8]" ,description:"We believe in the power of collaboration working closely with clients and partners to the cultivate strong and life-long"}
];
